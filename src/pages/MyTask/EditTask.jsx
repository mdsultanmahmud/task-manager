    ...
    return (
        <div id='addtask-container' className='bg-gray-100 dark:bg-gray-800'>
            ...
            <div className="child-container bg-gray-800 border relative">
                ...
                <div>
                    <label htmlFor="last_name" className="block mb-2 text-sm font-medium text-gray-300 dark:text-white">Edit Task Name</label>
                ...
                <div>
                    <label htmlFor="last_name" className="block mb-2 text-sm font-medium text-gray-300 dark:text-white">Re-set End Date</label>
                ...
                <div>
                    <label htmlFor="last_name" className="block mb-2 text-sm font-medium text-gray-300 dark:text-white">Re-set Image URL</label>
                ...
                <div>
                    <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-300 dark:text-white">Edit Task Description</label>
